...
class TestNamara(TestCase):
    ...
    def test_base_path(self):
        ...
        self.assertTrue(path == 'http://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2')

    def test_path(self):
        path = self.subject.get_path(self.dataset, self.version)
        self.assertTrue(path == 'http://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey')
